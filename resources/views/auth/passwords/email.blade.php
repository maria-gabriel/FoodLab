                              ...
                              <div class="p-3">
                                ...
                                @endif
                                 <form method="POST" action="{{ route('password.email') }}">
                                    ...
                                    <div class="row">
                                       <div class="col-lg-12">
                                          <div class="floating-label form-group">
                                             <input id="email" type="email" class="floating-input form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="correo" autofocus>
                                             <label>Correo</label>
                                             @error('email')
                                    ...
                                    <p class="mt-3 ml-2">
                                       <a href="{{ route('login') }}" class="text-primary">Regresar</a>
                                    </p>
                                 </form>
                              </div>
                           </div>
