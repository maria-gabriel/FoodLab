...
<div class="wrapper">
    <div class="content-page">
      <div class="container-fluid">
         ...
         <!--               <img src="../assets/img/page-img/profile.png" class="img-fluid rounded w-100" alt="profile-image">-->
         <!--            </div>-->
         <!--         </div>-->
         <!--      </div>-->
         <!--   </div>-->
                  ...
                  <div class="card-body">
                     <div class="d-flex align-items-center mb-3">
                        <div class="profile-img position-relative">
                           <img src="https://catbobber.com/wp-content/uploads/2022/05/web-1.png" class="img-fluid rounded avatar-110" alt="profile-image">
                        </div>
                        <div class="ml-3">
                           <h4 class="mb-1">{{ Auth::user()->nombre }} {{ Auth::user()->apellido }}</h4>
                           <p class="mb-2">Catbobber team</p>
                     ...
                     <ul class="list-inline p-0 m-0">
                        ...
                        <li class="mb-2">
                           <div class="d-flex align-items-center">
                              ...
                              <p class="mb-0">Mesero {{ Auth::user()->id }}</p>   
                           </div>
                        </li>
                        <li class="mb-2">
                           <div class="d-flex align-items-center">
               ...
               <div class="card card-block card-stretch card-height">
                  <div class="card-body">
                         ...
                         <div class="card card-block card-stretch mb-4">
                            ...
                            <div class="card-body p-4">
                               <div class="p-2 bg-warning rounded w-100 mb-3">
                                  <div class="d-flex align-items-center">
                                     <!--<span class="skill-number text-bold">1.</span>-->
                                     <h5 class="mb-0 ml-2">Creativo</h5>   
                                  </div>
                               </div>
                               <div class="p-2 bg-danger rounded w-100 mb-3">
                                  <div class="d-flex align-items-center">
                                     <!--<span class="skill-number text-bold">2.</span>-->
                                     <h5 class="mb-0 ml-2">Profesional</h5>   
                                  </div>
                               </div>
                               <div class="p-2 bg-info rounded w-100 mb-3">
                                  <div class="d-flex align-items-center">
                                     <!--<span class="skill-number text-bold">3.</span>-->
                                     <h5 class="mb-0 ml-2">Gruñón</h5>   
                                  </div>
                               </div>
                               <div class="p-2 bg-success rounded w-100 mb-3">
                                  <div class="d-flex align-items-center">
                                     <!--<span class="skill-number text-bold">4.</span>-->
                                     <h5 class="mb-0 ml-2">Desorganizado</h5>   
                                  </div>
                               </div>
                            </div>
                         </div>
                    ...
                    <!--</ul>-->
                     ...
                     <!--                     <img src="../assets/img/profile/service/01.png" class="img-fluid" alt="image">-->
                     ...
                     <!--               <li class="mb-4">-->
                     <!--                  <div class="d-flex align-items-center pt-2">-->
                     <!--                     <img src="../assets/img/profile/service/02.png" class="img-fluid mr-3" alt="image">-->
                     <!--                     <div class="ml-3 w-100">-->
                     <!--                        <div class="media align-items-center justify-content-between">-->
                     ...
                     <!--               <li>-->
                     <!--                  <div class="d-flex align-items-center pt-2">-->
                     <!--                     <img src="../assets/img/profile/service/03.png" class="img-fluid" alt="image">-->
                     <!--                     <div class="ml-3 w-100">-->
                     <!--                        <div class="media align-items-center justify-content-between">-->
                     <!--                           <p class="mb-0">Adobe Photoshop</p>-->
                     <!--                           <h6>85%</h6>-->
                     ...
                     <!--               <li class="mb-4">-->
                     <!--                  <div class="d-flex align-items-center pt-2">-->
                     <!--                     <img src="../assets/img/profile/service/04.png" class="img-fluid" alt="image">-->
                     <!--                     <div class="ml-3 w-100">-->
                     <!--                        <div class="media align-items-center justify-content-between">-->
                     <!--                           <p class="mb-0">Adobe Photoshop</p>-->
                     <!--                           <h6>85%</h6>-->
                     ...
                     <!--               <li class="mb-4">-->
                     <!--                  <div class="d-flex align-items-center pt-2">-->
                     <!--                     <img src="../assets/img/profile/service/05.png" class="img-fluid" alt="image">-->
                     <!--                     <div class="ml-3 w-100">-->
                     <!--                        <div class="media align-items-center justify-content-between">-->
                     <!--                           <p class="mb-0">Figma</p>-->
                     <!--                           <h6>85%</h6>-->
                     ...
                     <!--               <li>-->
                     <!--                  <div class="d-flex align-items-center pt-2">-->
                     <!--                     <img src="../assets/img/profile/service/06.png" class="img-fluid" alt="image">-->
                     <!--                     <div class="ml-3 w-100">-->
                     <!--                        <div class="media align-items-center justify-content-between">-->
                     <!--                           <p class="mb-0">Adobe Photoshop</p>-->
                     <!--                           <h6>85%</h6>-->
